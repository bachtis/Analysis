...
estimator.processTree("/scratch3/Kalman/data/{era}/ZMC.root".format(era=Era),"pt1>20.0&&pt2>20.0&&abs(eta1)<2.4&&abs(eta2)<2.4&&gc1>0&&gc2>0")
estimator.processTree("/scratch3/Kalman/data/{era}/ZJETSMC.root".format(era=Era),"pt1>20.0&&pt2>20.0&&abs(eta1)<2.4&&abs(eta2)<2.4&&gc1>0&&gc2>0")
estimator.close()
