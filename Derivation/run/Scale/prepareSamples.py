...
processor_JPSI_MC = ROOT.NtupleProcessor("JPsiInputPre.root",1,3.095*0.9992/1.0006,0.0,0.0,"DATA_Moriond17_13TeV",3);
processor_JPSI_MC.processTree("/scratch3/Kalman/data/{era}/Jpsi.root".format(era=Era),"pt1>6&&pt2>6&&mass>2.895&&mass<3.295",2.4)
processor_JPSI_MC.close()
...
#processor_Z_MC = ROOT.NtupleProcessor("ZMCInputCentral.root",0,90.851,0,2.5,"MC_Moriond17_13TeV");
