...
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","A_0","A1",f)
fetch("KalmanFilter/calibrationDATA13TeV.root","K_0","A2",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","M_0","e",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","B0_0","B0",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","B1_0","B1",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","B2_0","B2",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","C1_0","C1",f)
fetch("KalmanFilter/calibrationDATA13TeVBINNED.root","C2_0","C2",f)
fetchCovariance("KalmanFilter/calibrationDATA13TeVBINNED.root","COVARIANCE_0",f)
...
fetch("MagneticMap/mapCorrections.root","magnetic","magnetic",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","A_0","A1",f)
fetch("KalmanFilter/calibrationMC13TeV.root","K_0","A2",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","M_0","e",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","B0_0","B0",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","B1_0","B1",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","B2_0","B2",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","C1_0","C1",f)
fetch("KalmanFilter/calibrationMC13TeVBINNED.root","C2_0","C2",f)
fetchCovariance("KalmanFilter/calibrationMC13TeVBINNED.root","COVARIANCE_0",f)
