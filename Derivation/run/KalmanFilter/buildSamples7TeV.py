...
#splitter.split('../../data/JDATA.root','JDATA.root',[calibratorData.correct],[jSelect])
#splitter.split('../../data/YDATA.root','YDATA.root',[calibratorData.correct],[ySelect])


splitter.split('/data/bachtis/CALIB/7TeV/JDATA.root','JDATA7TeV.root',[calibratorData.correct],[jSelect])
splitter.split('/data/bachtis/CALIB/7TeV/YDATA.root','YDATA7TeV.root',[calibratorData.correct],[ySelect])



splitter.split('/data/bachtis/CALIB/7TeV/JMC.root','JMC7TeV.root',[],[jSelect])
splitter.split('/data/bachtis/CALIB/7TeV/YMC.root','YMC7TeV.root',[],[ySelect])
