...
fetch("step3_KalmanFilter/kalmanScale_mc2.root","A_0","A1",f)
fetch("step3_KalmanFilter/kalmanScale_mc2.root","K_0","A2",f)
fetch("step3_KalmanFilter/kalmanScale_mc2.root","B_0","B",f)
fetch("step3_KalmanFilter/kalmanScale_mc2.root","M_0","e",f)
